...
[Migration("20231101230918_AlteredOrixasConstraint")]
partial class AlteredOrixasConstraint
{
    /// <inheritdoc />
...
#pragma warning disable 612, 618
        ...
        modelBuilder.Entity("Lira.Data.Entities.PersonEntity", b =>
        {
            ...
            {
                t.HasCheckConstraint("CK_people_status", "status IN ('Active', 'Inactive', 'Deleted')");
            });
        });

        modelBuilder.Entity("Lira.Data.Entities.PersonOrixaEntity", b =>
        {
            b.Property<Guid>("Id")
                .ValueGeneratedOnAdd()
                .HasColumnType("uuid")
            ...
            b.ToTable("person_orixas", null, t =>
            {
        ...
        modelBuilder.Entity("Lira.Data.Entities.MediumEntity", b =>
        {
            b.HasOne("Lira.Data.Entities.PersonEntity", "Person")
                .WithOne("Medium")
                .HasForeignKey("Lira.Data.Entities.MediumEntity", "PersonId")
                .OnDelete(DeleteBehavior.Cascade)
                .IsRequired()
        ...
        modelBuilder.Entity("Lira.Data.Entities.PersonOrixaEntity", b =>
        {
            b.HasOne("Lira.Data.Entities.OrixaEntity", "Orixa")
                .WithMany("PersonOrixas")
                .HasForeignKey("OrixaId")
                .OnDelete(DeleteBehavior.Cascade)
                .IsRequired()
